...
Due to the confidential nature of the data for my thesis, this DATA 555 project uses a mock dataset with the same sample size, variables of interest, and variable value ranges as the thesis data. Similar, but not exact, distributions for the variables were simulated. This was done to protect the identities of participants in my thesis project. 

GitHub repository link: ________________________________________
...
#flexdashboard layout plotly title resize to window 

# onRender(psa_plotly, "
# function(el, x) {
#   function resizeTitle() {
#     var width = el.offsetWidth;
#     var fontSize = Math.max(14, Math.min(28, width / 25));
#     if (layout && layout.title) {
#       layout.title.font.size = fontSize;
#       Plotly.relayout(el, { 'title.font.size': fontSize });
#     }
#   }
#   resizeTitle();
